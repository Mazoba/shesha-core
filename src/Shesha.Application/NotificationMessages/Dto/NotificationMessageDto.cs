...
namespace Shesha.NotificationMessages.Dto
{
    public class NotificationMessageDto : EntityDto<Guid>
    {
        ...
        /// </summary>
        public EntityWithDisplayNameDto<Guid?> Sender { get; set; }

        /// <summary>
        /// Recipient (person) of the message
        /// </summary>
        public EntityWithDisplayNameDto<Guid?> Recipient { get; set; }
        ...
        /// </summary>
        public EntityWithDisplayNameDto<Guid?> Template { get; set; }

        /// <summary>
        /// Notification
        /// </summary>
        public EntityWithDisplayNameDto<Guid?> Notification { get; set; }
