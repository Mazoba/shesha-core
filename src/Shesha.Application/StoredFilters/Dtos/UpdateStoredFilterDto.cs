...
{
    /// <summary>
    /// Create a Stored Filter data contract
    /// </summary>
    public class UpdateStoredFilterDto : EntityDto<Guid>
    {
        /// <summary>
        /// List of container entity links such as Reporting Framework reports.
        /// For datatable there is no entity so only ID is provided (the table ID)
        /// </summary>
